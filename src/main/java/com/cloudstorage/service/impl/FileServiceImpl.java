...
import com.cloudstorage.util.ListUtil;
import com.cloudstorage.util.SearchFileByKey;
...
public class FileServiceImpl implements IFileService {
    ...
    public List<FileMsg> userFileList(String userName, String path) {
        ...
        for (int i = 0; i < tempList.length; i++) {
            if (tempList[i].isFile()) {
                ...
                String size = FileUtil.fileSizeToString(tempList[i].length());
    ...
    public boolean userFileRename(String oldName, String newName, String userName, String path) {
        ...
        if ("@dir@".equals(oldName)){
            ...
            newNameWithPath = oldNameWithPath.substring(0, (int) StringUtil.getfilesuffix(oldNameWithPath, true, "/")) + "/" + newName;
    ...
    public boolean userFileDirMove(String fileName, String oldPath, String newPath, String userName) {
        ...
        String tmpnewfilename = "@dir@".equals(fileName)? (String) StringUtil.getfilesuffix(oldNameWithPath, false, "/", false): "";
